        ...
        <div className='flex flex-col min-h-dvh w-[45%] bg-white items-center justify-center gap-10 overflow-hidden'>
          ...
          <form className='flex flex-col items-center justify-center items-center justify-center w-[50%] gap-5'>
            <div className='flex flex-col items-center justify-center w-full'>
              ...
              <input className='w-full rounded-xl bg-[var(--tomoi-gray)] border-1 border-black py-2 px-4' type="text" id="username" name="username" />
            </div>
            ...
            <div className='flex flex-col items-center justify-center w-full'>
              ...
              <input className='w-full rounded-xl bg-[var(--tomoi-gray)] border-1 border-black py-2 px-4' type="password" id="password" name="password" />
            </div>

            <div className='flex items-center w-full'>
              <input type='checkbox' className='cursor-pointer' id='remember' defaultValue={false} />
              <label className='ml-2' htmlFor="remember">Remember me next time</label>
            </div>

            <div className='flex flex-col items-center justify-center w-full gap-2'>
              <button className='w-full bg-[var(--tomoi-green)] hover:bg-[var(--tomoi-green-d)] rounded-full py-2 px-4 font-bold shadow-sm' type="submit">Login</button>
              <div>- or -</div>
              <button className='flex flex-row gap-3 items-center justify-center w-full bg-[var(--tomoi-gray-l)] hover:bg-[var(--tomoi-gray-d)] rounded-full py-2 px-4 font-bold shadow-sm' type="button">
          ...
          <div className='flex flex-col gap-2 w-[50%] items-center justify-center'>
            ...
            <button className='flex flex-row gap-2 items-center justify-center w-full bg-[var(--tomoi-yellow)] hover:bg-[var(--tomoi-yellow-d)] rounded-full py-2 px-4 font-bold shadow-sm' type="button">
              Sign Up
            </button>
          </div>
