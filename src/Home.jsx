        ...
        <div className='flex flex-col min-h-dvh h-screen w-full overflow-y-auto bg-white justify-center items-center'>
            <div className='flex w-full max-w-7xl h-[80%] items-stretch justify-center z-10 gap-4'>
                ...
                <div className='flex flex-col w-[35%] gap-2'>
                    <div className='shadow-md/40 bg-[var(--tomoi-gray-l)] h-[50%] gap-1 rounded-xl flex flex-col p-4'>
                    ...
                    <div className='flex flex-col h-[50%] gap-1 p-2'>
                        ...
                        <div className='flex shadow-md/40 bg-white rounded-xl overflow-hidden h-full'>
                            ...
                            <div className='grow-2 border-dashed border-l-2 p-4 max-w-[50%] flex flex-col gap-3 items-between justify-around'>
                                <div>
                                ...
                                <div className='flex gap-3 flex-wrap'>
                                    <div className='px-2 border-1 border-dashed border-[var(--tomoi-gray-d)] bg-[var(--tomoi-gray-l)]'>#blessed</div>
                                    <div className='px-2 border-1 border-dashed border-[var(--tomoi-gray-d)] bg-[var(--tomoi-gray-l)]'>school</div>
                                    <div className='px-2 border-1 border-dashed border-[var(--tomoi-gray-d)] bg-[var(--tomoi-gray-l)]'>dreams</div>
                                </div>
                            </div>
                        </div>
                    </div>
